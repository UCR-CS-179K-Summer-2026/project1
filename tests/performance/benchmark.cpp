...
const vector<BenchmarkDataset> BENCHMARK_DATASETS = {
    {
        ...
        85032,
        {
            ...
            {"filter_average",
             R"(GROUPBY(GET("major")) | FILTER(AVERAGE(GET("gpa")) > 3) | GET("Statistics", 0, "student_id"))",
             "1"}
        }
    },
    {
        ...
        70792,
        {
            ...
            {"filter_average",
             R"(GROUPBY(GET("make")) | FILTER(AVERAGE(GET("price_usd")) > 60000) | GET("Kia", 0, "car_id"))",
             "1"}
        }
    },
    {
        ...
        47587,
        {
            ...
            {"filter_average",
             R"(GROUPBY(GET("property_type")) | FILTER(AVERAGE(GET("price_usd")) > 2500000) | GET("Single Family", 0, "listing_id"))",
             "1"}
        }
    },
    {
        ...
        43315,
        {
            ...
            {"filter_average",
             R"(GROUPBY(GET("country")) | FILTER(AVERAGE(GET("runtime_minutes")) > 139) | GET("Mexico", 0, "movie_id"))",
             "1"}
        }
    }
};
